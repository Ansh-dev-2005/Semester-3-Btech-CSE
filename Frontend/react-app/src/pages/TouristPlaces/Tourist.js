...
export default function Tourist() {
    ...
    // Function to fetch nearby places related to Tourist using the user's location
    const fetchTouristPlaces = async (latitude, longitude) => {
        ...
        const options = {
            ...
            params: {
                ...
                radius: '150000',
                keyword: 'Tourist Places', // You can adjust the keyword as needed
    ...
    return (
        <div className="p-4">
            {Object.keys(TouristPlaces).map((category, index) => (
                <div key={index} className="mb-4">
                    <h2 className="text-2xl font-bold">{formatCategoryName(category)}</h2>
                    <ul>
                        {TouristPlaces[category].map((place, placeIndex) => (
